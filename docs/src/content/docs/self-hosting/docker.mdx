...
<Steps>
  ...
  <Step title="Copy and configure environment variables">
    ...
    Edit `.env` with your configuration. At minimum, set: <Badge variant="danger">BOT_TOKEN</Badge>, <Badge variant="danger">OWNER_ID</Badge>, <Badge variant="danger">MESSAGE_DUMP</Badge>.
  </Step>
