...
<CardGroup cols={2}>
  ...
  <Card title="Alita vs Miss Rose" href="/getting-started/feature-comparison/" icon="git-compare">
    Feature map against [Miss Rose](https://missrose.org/) — what we have, what is partial, and what we still lack.
  </Card>
</CardGroup>
