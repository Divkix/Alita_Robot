...
9. **Initial Checks** <Badge text="Validation" variant="note" />
    
    Validates configuration and performs startup health checks.
    
    ```go
    alita.InitialChecks(b)  // Validates config and performs startup health checks
    ```

11. **Dispatcher Creation** <Badge text="Core" variant="note" />
...
12. **Monitoring Systems** <Badge text="Observability" variant="success" />
...
13. **HTTP Server & Mode Selection** <Badge text="Core" variant="note" />
