...
2. **Panic Recovery Setup** <Badge text="Safety" variant="caution" />
...
3. **Locale Manager Initialization** <Badge text="i18n" variant="note" />
...
4. **OpenTelemetry Tracing Initialization** <Badge text="Observability" variant="success" />
...
5. **HTTP Transport Configuration** <Badge text="Networking" variant="note" />
...
6. **Bot Client Creation** <Badge text="Core" variant="note" />
...
7. **Connection Pre-warming** <Badge text="Performance" variant="tip" />
...
8. **Initial Checks** <Badge text="Validation" variant="note" />
...
9. **Async Processor** <Badge text="Optional" variant="default" />
...
10. **Dispatcher Creation** <Badge text="Core" variant="note" />
...
11. **Monitoring Systems** <Badge text="Observability" variant="success" />
...
12. **HTTP Server & Mode Selection** <Badge text="Core" variant="note" />
