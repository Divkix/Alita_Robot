...
- alita/ **Core application code**
  ...
  - db/ **Database layer**
    ...
    - monitoring.go Database pool metrics
    - optimized_queries.go Cached optimized queries
    - backup_db.go Export/import chat data
    - backup_types.go Backup format types
