...
must_haves:
  truths:
    ...
    - "`bun run build` in docs/ invokes starlight-links-validator and either passes with 0 broken links or fails listing specific broken link paths — in either case the tool is operational"
  artifacts:
